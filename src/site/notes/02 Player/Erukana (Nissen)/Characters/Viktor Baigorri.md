---
{"dg-publish":true,"permalink":"/02 Player/Erukana (Nissen)/Characters/Viktor Baigorri/","tags":["erukana","pc","warrior","azur-ordenen","astley-avengers"],"dg-note-properties":{"sessions":["[[36 - Erukana - Steffen - Corwin & Viktor 14|session 36]]","[[37 - 261125 - Erukana - Steffen - Infernal Machine - 15|session 37]]","[[39 - 151225 - Erukana - steffen 16 - Return to Vardestjernen|session 39]]","[[42- 210226 - Erukana - Nisen - ShipJacking|session 42]]","[[43 - 280326 - Erukana - Nissen - Sailing in the clouds|session 43]]"],"category":"pc","Profession":["Warrior"],"Faction":["[[02 Player/Erukana (Nissen)/Factions/Astley Avengers\|Astley Avengers]]","[[02 Player/Erukana (Nissen)/Factions/Azur ordenen\|Azur ordenen]]"],"Location":["[[Baroniet Botreaux\|Baroniet Botreaux]]"],"Campaign":"Erukana","aliases":["Viktor","Victor","Viktor Baigorri"],"tags":["erukana","pc","warrior","azur-ordenen","astley-avengers"],"race":"human","role":["military"],"social_status":"nobility","affiliation":["[[02 Player/Erukana (Nissen)/Factions/Astley Avengers\|Astley Avengers]]","[[02 Player/Erukana (Nissen)/Factions/Azur ordenen\|Azur ordenen]]"],"disposition":"ally","status":"alive","location_primary":"[[Baroniet Botreaux\|Baroniet Botreaux]]"}}
---
...
- Hidkaldt via ritual af [[Ivan\|Ivan]] ved Tempus-helligdommen
- **Navn**: Viktor Baigorri, "fra tårnet"
- Født sydpå i [[Baroniet Botreaux\|Baroniet Botreaux]] — betragter sig selv som adel
- Trænet til at slås hos byens vagter
- Hans tidligere eventyrgruppe paralyserede ham under et dæmonangreb i en grotte og flygtede — han jagter dem
- Modtager magisk bracer-skjold fra Ivans klan-kiste: foldes ud med en action, +1 shield (+3 AC), kan vælge drage-type

### Session 37 — Helvedes Maskinen
- Vælger **ild** som drage-fokus for sit skjold
- Deltager i kampen mod helvedes maskinen
- Falder i kamp — Nibar bruger Dimension Door, Logan hælder healing potion i ham; Tempus healer gruppen

### Session 39 — Vardestjernen
- Metalvogter-konstruktionen scanner Viktor: *"kritisk identifikation, arkanisk match. Velkommen broder det glæder denne enhed at møde en af ordnen"*
- Identificeret som tilhørende [[02 Player/Erukana (Nissen)/Factions/Azur ordenen\|Azur ordenen]] — forbindelsen er uforklaret

### Session 42 — ShipJacking
- Siger ja til formelt medlemskab af [[02 Player/Erukana (Nissen)/Factions/Astley Avengers\|Astley Avengers]]
- Hævner [[02 Player/Erukana (Nissen)/People/Evelyn Adair\|Evelyn Adair]] ved at dræbe skyggenglen med shadow blade
