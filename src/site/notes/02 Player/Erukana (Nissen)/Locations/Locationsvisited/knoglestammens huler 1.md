---
{"dg-publish":true,"permalink":"/02 Player/Erukana (Nissen)/Locations/Locationsvisited/knoglestammens huler 1/","tags":["erukana","location"],"dg-note-properties":{"sessions":["[[02 Player/Erukana (Nissen)/26 - 310525 - Erukana - nissen 18 - Frosty Northern Forest|session 26]]","[[02 Player/Erukana (Nissen)/27 - 210625 - Eurkana - nissen 19 -|session 27]]"],"category":"location","Campaign":"Erukana","tags":["erukana","location"]}}
---


> **Note**: This file is a location (dungeon/cave system), not a faction. It is filed in the Factions folder but should likely be moved to the Locations folder. It describes the cave home of [[02 Player/Erukana (Nissen)/Factions/Knoglestammen\|Knoglestammen]].

## Description
Knoglestammens huler er hjemsted for [[02 Player/Erukana (Nissen)/Factions/Knoglestammen\|Knoglestammen]] og ligger i [[02 Player/Erukana (Nissen)/Locations/Locationsvisited/StormBjerget\|StormBjerget]]. Hulerne er groft udhugget tunneller der fører til egentlige lokaler og rum. Der er falmet graveringer på væggene der ikke er blevet vedligeholdt. Tronsalen er i forfald men har sikkert været imponerende engang. Hulerne tilhørte engang Wayruth-klanen.

## Notes
### Session 26
- Gruppen ankom 23. Ches 1517
- Svala Enøje overtaler en ældre herre til at gruppen får fortræde for høvdingen
...
## Tags
#erukana #location #dungeon #knoglestammen
